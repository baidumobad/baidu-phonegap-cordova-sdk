var baiduAd = {
    ...
    initBanner: function (appSid,appSec, successCallback, failureCallback) {
        cordova.exec(
            successCallback,
            failureCallback,
            'BaiduAdPlugin',
            'baiduInitBanner',
            [
                {appSid: appSid, appSec:appSec}
            ]
        );
    },
    initInterstitial: function (appSid,appSec, successCallback, failureCallback) {
        cordova.exec(
            successCallback,
            failureCallback,
            'BaiduAdPlugin',
